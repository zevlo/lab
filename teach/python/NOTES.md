...
- **(2026-07-03) Hold difficulty steady — do not auto-escalate.** User explicitly said not to bump difficulty just because they score well. Current level (guided exercise steps + expected output to self-check) IS the zone of proximal development. Only increase when a lesson's material genuinely requires it or the user asks.
