...
**Canonical path (11 lessons):** `0001` Vim → `0006` tmux → `0015` Shell (MS 1) → `0019` CLI conventions (MS 2a) → `0024` Remote & home (MS 2b) → `0026` Dev environment (MS 3) → `0031` Debugging (MS 4a) → `0036` Profiling (MS 4b) → `0040` Git (MS 5) → `0041` Shipping (MS 6) → `0042` Agentic coding (MS 7). Remaining MS lectures: Beyond the Code (8), Code Quality (9).

**Next up:** L0042 in flight — MS lecture 7 Agentic Coding. Leftover shipping sittings on L0041 are optional. L0039 (massif) stays withdrawn — notes-only, not an exercise.
